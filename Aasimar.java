...
public class Aasimar {
    ...
    // Special abilities
    String special = "Celestial Resistance: Necrotic and radiant damage.\n" +
...
class SubRaceProtector extends Aasimar {
    ...
    // special subRace
    String subSpecial = "Radiant Soul: Starting at 3rd level, you can unleash the divine energy as an action. When you do so, your eyes glimmer and two luminous, ghost-like wings emerge from your back and you gain a flying speed of 30 feet. The transformation lasts for 1 min, and once on each of your turns you can deal extra radiant damage equal to your level, whenever you damage a creature with an attack or spell. You can cancel Radiant Soul with a bonus action, and cannot use it again until you take a long rest.";
}
...
class SubRaceScourge extends Aasimar {
    ...
    // special subRace
    String subSpecial = "Radiant Consumption: Starting at 3rd level, you can unleash your divine energy as an action. When you do so, searing light pours out your eyes and mouth for 1 min. During this time, you shed bright light for 10 feet, dim light for another 10 feet. At the end of each your turns, you and all creatures within 10 feet take radiant damage equal to half your level (rounded up). In addition, once on each of your turns, you can deal extra radiant damage to a single creature equal to your level. You can cancel Radiant Consumption as a bonus action and must finish a long rest before you can use this ability again.";
}
